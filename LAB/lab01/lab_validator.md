...
* El conjunto de datos debe tener la columna del ID según el tipo de datos que corresponda: <span style="color:blue">*occurenceID*</span> (registros biológicos), *eventID* (eventos de muestreo) o *taxonID* (listas de especies). La columna debe estar documentada para todas las filas y cada ID debe ser único.
