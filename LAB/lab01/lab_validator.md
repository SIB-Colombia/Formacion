...
* El conjunto de datos debe tener la columna del ID según el tipo de datos que corresponda: <span style="color:LimeGreen">*occurenceID*</span> (registros biológicos), <span style="color:LimeGreen">*eventID*</span> (eventos de muestreo) o <span style="color:LimeGreen">*taxonID*</span> (listas de especies). La columna debe estar documentada para todas las filas y cada ID debe ser único.
